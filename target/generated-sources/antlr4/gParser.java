...
public class gParser extends Parser {
	...
	public static final int
		T__7=1, T__6=2, T__5=3, T__4=4, T__3=5, T__2=6, T__1=7, T__0=8, QUOT=9, 
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'Alors'", "'Out_SJ'", "'Si'", "'Sinon'", "'In_SJ'", "'class_SJ'", 
		"'main_SJ'", "'import'", "'\"'", "';'", "','", "'('", "')'", "'*'", "'/'", 
		"'+'", "'-'", "':='", "'>'", "'>='", "'<'", "'<='", "'='", "'!='", "'&'", 
		"'|'", "'!'", "'{'", "'}'", "CLASS_NAME", "MODIFIER", "VAR_TYPE", "ID", 
		"LIBRARY", "NUMBER", "FORMAT", "STR", "COMMENT", "WHITESPACE"
	};
	public static final int
	...
	public final AxiomContext axiom() throws RecognitionException {
		...
		try {
			...
			if (_la==MODIFIER) {
				{
				setState(48); match(MODIFIER);
				}
			}

			setState(51); match(T__2);
			setState(52); match(CLASS_NAME);
			setState(53); match(L_BR);
			setState(57);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==VAR_TYPE) {
			...
			if (_la==T__1) {
				{
				setState(60); mainBlock();
				}
			}

			setState(63); match(R_BR);
	...
	public final InstBlockContext instBlock() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(93); match(L_BR);
			setState(97);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__6) | (1L << T__5) | (1L << T__3) | (1L << ID))) != 0)) {
				{
				{
				setState(94); instruction();
				}
				}
				setState(99);
				_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(132); match(TIMES);
						setState(133); expression(8);
						}
						break;
					case 2:
						{
						...
						setState(135); match(DIV);
						setState(136); expression(7);
						}
						break;
					case 3:
						{
						...
						setState(138); match(PLUS);
						setState(139); expression(6);
						}
						break;
					case 4:
						{
	...
	public final ConditionContext condition() throws RecognitionException {
		...
		try {
			...
			setState(149); thenBlock();
			setState(151);
			switch ( getInterpreter().adaptivePredict(_input,14,_ctx) ) {
			case 1:
				{
				setState(150); elseBlock();
				}
				break;
			}
			}
	...
	public final IfStatementContext ifStatement() throws RecognitionException {
		...
		try {
			...
			setState(158); match(L_PAREN);
			setState(159); evaluation(0);
			setState(160); match(R_PAREN);
	...
	private EvaluationContext evaluation(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(166); match(L_PAREN);
				setState(167); evaluation(0);
				setState(168); match(R_PAREN);
				}
				break;
			case 3:
				{
	...
	public final OutputContext output() throws RecognitionException {
		...
		try {
			...
			setState(210); match(L_PAREN);
			setState(211); outputArgs();
			setState(212); match(R_PAREN);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OutputArgsContext outputArgs() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(214); strFormat();
			setState(216);
			_la = _input.LA(1);
			if (_la==COMA) {
				{
				setState(215); outputIdList();
				}
			}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 13: return evaluation_sempred((EvaluationContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\25\32\3\2&\'\u00ea\2/\3\2\2\2\4D\3\2\2\2\6K\3\2\2\2\bM\3\2\2\2\nT\3\2"+
		"\2\2\f\\\3\2\2\2\16_\3\2\2\2\20s\3\2\2\2\22u\3\2\2\2\24\u0083\3\2\2\2"+
		"\26\u0096\3\2\2\2\30\u009d\3\2\2\2\32\u009f\3\2\2\2\34\u00b0\3\2\2\2\36"+
